...
<c:if test="${param.msg != null}"><div class="alert alert-warning"><p class="msg">${param.msg}</p></div></c:if>

<c:if test="${msg != null}"><div class="alert alert-warning"><p class="msg">${msg}</p></div></c:if>
<c:if test="${msgOK != null}"><div class="alert alert-success"><p class="msg">${msg}</p></div></c:if>
